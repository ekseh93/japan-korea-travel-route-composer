...
> 공개 URL·사용자 지표: 없음  
> LUN-014 검증: format·lint·typecheck·57개 테스트·브라우저 E2E 3건·build·catalog:validate·catalog:build·의존성 감사 통과; Terraform fmt/validate·TFLint·Trivy는 직전 CI 통과 (2026-08-15)
> GitHub CI 검증: quality·browser-e2e·terraform-static 3개 작업 통과 ([실행 결과](https://github.com/ekseh93/japan-korea-travel-route-composer/actions/runs/31865408214), 2026-08-15)
...
| 테스트·빌드 | LUN-001~014 Gate 기준 format·lint·typecheck·57개 테스트·브라우저 E2E 3건·build·catalog:validate·catalog:build·frozen install·의존성 감사 실행; Terraform fmt/validate·TFLint·Trivy는 직전 GitHub CI 통과, 실제 Plan은 미실행 |
| AWS 리소스·배포 URL | 없음 |
| 실제 성능·가용성·사용자 지표 | 없음 |
