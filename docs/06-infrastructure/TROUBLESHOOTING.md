...
### 34. AWS 계정의 Lambda unreserved concurrency 최소값 충돌

- **문제:** Production run `31934959968`은 Remote State 기반 Plan `15 to add, 2 to change, 0 to destroy` 후
  Lambda 생성 중 `Specified ReservedConcurrentExecutions ... below its minimum value of [10]`으로 중단됐다.
